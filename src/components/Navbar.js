...
//   const drawerContent = (
//     <Box sx={{ width: { xs: "80vw", sm: "320px" }, height: "100%", p: { xs: 2, sm: 3 }, display: "flex", flexDirection: "column" }}>
//       <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: { xs: 2, sm: 3 } }}>
//         <Typography variant="h5" sx={{ fontWeight: 700, color: "#2E7D32", fontSize: { xs: "1.5rem", sm: "1.75rem" }, fontFamily: "'Winky Sans', sans-serif" }}>
//           AgriHub
//         </Typography>
//         <IconButton onClick={toggleDrawer(false)}>
//           <CloseIcon sx={{ fontSize: "2rem", color: "#2E7D32" }} />
...
//       <FormControl sx={{ mb: 2 }}>
//         <Select value={language} onChange={handleLanguageChange} sx={{ color: "#2E7D32", fontFamily: "'Winky Sans', sans-serif" }}>
...
//     <ThemeProvider theme={theme}>
//       <AppBar position="fixed">
//         <Toolbar sx={{ py: { xs: 1.5, sm: 2, md: 2.5 }, px: { xs: 2, sm: 3 }, justifyContent: "space-between", alignItems: "center", minHeight: { xs: 70, sm: 80, md: 90 } }}>
//           {isMobile && (
...
//           {!isMobile && (
//             <Box sx={{ display: "flex", alignItems: "center", gap: { sm: 2, md: 3 }, justifyContent: "center", flexGrow: 1 }}>
//               {menuItems.map((item) => (
...
//start The Old Navbar 1037 Line Of the Page
import React, { useEffect, useState } from "react";
import '../fonts/fonts.css'
import {
  AppBar,
